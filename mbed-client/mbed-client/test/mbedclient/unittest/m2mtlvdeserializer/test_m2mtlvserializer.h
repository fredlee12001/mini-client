...
protected:
    void test_serialize_resource(M2MResourceBase::ResourceType resourceType, uint8_t *test_value);
    void test_serialize_resource_instance(M2MResourceBase::ResourceType resourceType, uint8_t *test_value);
};
