...
void Test_M2MTLVDeserializer::test_deserialise_object_instances()
{
    ...
    M2MObjectInstance* instance = new M2MObjectInstance(*object, 1, "1", "type", "1");

    M2MObjectInstance* instance_1 = new M2MObjectInstance(*object, 2, "2", "type", "2");
    ...
    instance->add_resource(resource_1);

    m2mresourcebase_stub::resource_type = M2MResourceBase::INTEGER;
    ...
    // Out of Memory
    m2mresourcebase_stub::bool_value = false;
    data = serializer->serialize( m2mobject_stub::instance_list,size);
    CHECK(M2MTLVDeserializer::OutOfMemory == deserializer->deserialise_object_instances(data,size,*object,M2MTLVDeserializer::Post));
    size = 0;
    if(data) {
        free(data);
        data = 0;
    ...
    memset(m2mresourcebase_stub::value, 0, m2mresourcebase_stub::int_value);
    ...
    delete serializer;
    // Resources not serialized, returns only object instances
    CHECK(M2MTLVDeserializer::None == deserializer->deserialise_object_instances(data,size,*object,M2MTLVDeserializer::Post));
    size = 0;
    ...
    m2mresourcebase_stub::bool_value = false;
    CHECK(M2MTLVDeserializer::OutOfMemory ==
          deserializer->deserialise_object_instances(data,size,*object,M2MTLVDeserializer::Post));
...
void Test_M2MTLVDeserializer::test_deserialize_resources()
{
    ...
    m2mresourcebase_stub::bool_value = true;
    M2MObject *object = new M2MObject(1,"1");
    M2MObjectInstance* instance = new M2MObjectInstance(*object, 0, "1","type", "1");
    ...
    M2MResource* resource2 = new M2MResource(*instance,
                                            "2",
                                            M2MBase::Dynamic,
                                            "type",
                                            M2MBase::INTEGER,
    ...
    instance->add_resource(resource);
    m2mobjectinstance_stub::resource_list.push_back(resource2);
    ...
    m2mbase_stub::operation = M2MBase::GET_PUT_POST_ALLOWED;
    uint8_t data_resource2[] = {0xC3,0x1,'A','R','M'};
    m2mbase_stub::name_id_value = 1;
    deserializer->deserialize_resources(data_resource2,sizeof(data_resource2),*instance,M2MTLVDeserializer::Put);
...
void Test_M2MTLVDeserializer::test_deserialize_resource_instance()
{
    ...
    M2MObjectInstance* instance_1 = new M2MObjectInstance(*object, 0, "2","type", "1");
    ...
    resource->remove_resource_instance(res_instance->name_id());
    resource->remove_resource_instance(res_instance_1->name_id());
    ...
    // re-create the resource instances since they were deleted earlier
    res_instance = new M2MResourceInstance(*resource,
                                                1,
                                                M2MBase::Dynamic,
                                                "type",
                                                M2MBase::INTEGER,
    ...
    res_instance_1 = new M2MResourceInstance(*resource,
                                              2,
                                              M2MBase::Dynamic,
                                              "type",
                                              M2MBase::INTEGER,
