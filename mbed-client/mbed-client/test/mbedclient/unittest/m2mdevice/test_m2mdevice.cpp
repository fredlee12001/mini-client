...
Test_M2MDevice::Test_M2MDevice()
{
    ...
    M2MObject* obj = new M2MObject(0, M2MBase::make_string(0));
    m2mobject_stub::inst = new M2MObjectInstance(*obj,
                                                 0,
                                                 "name",
                                                 M2MBase::make_string(0),"");
...
void Test_M2MDevice::test_set_resource_value_string()
{
    ...
    CHECK(device->set_resource_value(M2MDevice::SupportedBindingMode,"test") == true);
...
{
    M2MResource res(*m2mobject_stub::inst, 1,M2MBase::Dynamic,"test",M2MBase::STRING,false, M2MBase::make_string(1));

    m2mobject_stub::inst->add_resource(&res);

    M2MResource res2(*m2mobject_stub::inst, 2,M2MBase::Dynamic,"test",M2MBase::STRING,false, M2MBase::make_string(2));
