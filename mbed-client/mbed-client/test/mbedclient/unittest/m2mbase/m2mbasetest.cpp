...
TEST(M2MBase, test_create_path_max_size)
{
    m2m_base->test_create_path_max_size();
}
...
TEST(M2MBase, test_get_notification_msgid)
{
    m2m_base->test_get_notification_msgid();
}

TEST(M2MBase, test_set_notification_msgid)
{
    m2m_base->test_set_notification_msgid();
}
