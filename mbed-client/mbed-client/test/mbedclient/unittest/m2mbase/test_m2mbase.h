...
class Test_M2MBase : public M2MBase
{
public:
    Test_M2MBase(char* path, Handler *handler);
    Test_M2MBase(uint16_t name_id,
            M2MBase::Mode mode,
    ...
    void test_create_path_max_size();
    ...
    void test_set_notification_msgid();

    void test_get_notification_msgid();
