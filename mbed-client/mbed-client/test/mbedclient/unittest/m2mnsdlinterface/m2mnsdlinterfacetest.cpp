...
TEST(M2MNsdlInterface, update_endpoint)
{
...
TEST(M2MNsdlInterface, start_nsdl_execution_timer)
{
    m2m_nsdl_interface->test_start_nsdl_execution_timer();
}

TEST(M2MNsdlInterface, get_unregister_ongoing)
{
    m2m_nsdl_interface->test_get_unregister_ongoing();
}
