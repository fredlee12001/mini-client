...
Test_M2MServer::Test_M2MServer()
{
    ...
    M2MObject* obj = new M2MObject(1, M2MBase::make_string(1));
    m2mobject_stub::inst = new M2MObjectInstance(*obj, 0, "type", M2MBase::stringdup("1/0"));
