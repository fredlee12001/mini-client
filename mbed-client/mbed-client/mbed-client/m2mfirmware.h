...
private:
    ...
    /**
     * \brief Memory allocations for the firmware object.
...
private:
    ...
    // TODO: rename to resource_id()
    static uint16_t resource_name(FirmwareResource resource);

    bool create_mandatory_resources();
