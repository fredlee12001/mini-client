...
public:
     ...
     */
    const M2MObjectInstance* instances() const;

    M2MObjectInstance* instances();
    ...
    */
    ...
    inline const M2MObject* get_next() const;
    inline M2MObject* get_next();
    inline void set_next(M2MObject *next);
...
private :
     ...
     */
    void add_object_instance(M2MObjectInstance *object_instance);
...
private:
    ...
    M2MObjectInstance         *_instance_list;
...
inline const M2MObject* M2MObject::get_next() const
{
    return _next;
}

inline M2MObject* M2MObject::get_next()
{
    return _next;
}

inline void M2MObject::set_next(M2MObject* next)
{
    _next = next;
}
#endif // M2M_OBJECT_H
