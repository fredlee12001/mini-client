...
private:
    ...
    /**
     * \brief Memory allocations for the device object.
...
public:
     ...
     * \return M2MResource if created successfully, else NULL.
     */
    M2MResource* create_resource(DeviceResource resource, const char *value);
...
private:
    ...
    static uint16_t resource_name(DeviceResource resource);
