...
const uint8_t MAX_ALLOWED_STRING_LENGTH = 40;
const uint8_t MAX_ALLOWED_IP_STRING_LENGTH = 64;
...
#define ERROR_REASON_25 "Invalid security object"
#define ERROR_REASON_26 "/bs un-init"
