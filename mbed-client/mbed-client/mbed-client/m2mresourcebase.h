...
/**
 * \brief \brief Memory allocations for the parameters.
...
bool allocate_resources(const uint8_t *value,
     ...
     * \param base_type The base type of the object, should be Resource or ResourceInstance.
     ...
     */
    M2MResourceBase(M2MBase::BaseType base_type,
                    uint16_t resource_name,
                    M2MBase::Mode mode,
...
public:
     ...
     */
    void get_value(uint8_t *&value, uint32_t &value_length) const;
    ...
    */
     ...
     * \return Object name.
    */
    virtual uint16_t object_id() const = 0;
...
private:
    ...
    static M2MResourceBase::ResourceType convert_data_type(M2MBase::DataType type);
