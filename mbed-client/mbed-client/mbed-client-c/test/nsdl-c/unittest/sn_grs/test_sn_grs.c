...
//    res->resource[1] = '\0';
    ...
    res->resource_type_ptr = (uint8_t*)malloc(2);
    res->resource_type_ptr[0] = 'a';
    res->resource_type_ptr[1] = '\0';
#endif
#ifndef DISABLE_INTERFACE_DESCRIPTION
    res->interface_description_ptr = (uint8_t*)malloc(2);
    res->interface_description_ptr[0] = 'a';
    res->interface_description_ptr[1] = '\0';
#endif
#else
    res->static_resource_parameters->attributes_ptr = 0;
#endif
...
#ifndef RESOURCE_ATTRIBUTES_LIST
#ifndef DISABLE_INTERFACE_DESCRIPTION
    free(res->interface_description_ptr);

#endif
#ifndef DISABLE_RESOURCE_TYPE
    free(res->resource_type_ptr);
