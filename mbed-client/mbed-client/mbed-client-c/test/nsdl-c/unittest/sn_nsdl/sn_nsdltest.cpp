...
TEST(sn_nsdl, test_sn_nsdl_free_resource_attributes_list)
{
    CHECK(test_sn_nsdl_free_resource_attributes_list());
}

TEST(sn_nsdl, test_sn_nsdl_set_resource_attribute)
{
    CHECK(test_sn_nsdl_set_resource_attribute());
}

TEST(sn_nsdl, test_sn_nsdl_get_resource_attribute)
{
    CHECK(test_sn_nsdl_get_resource_attribute());
}

TEST(sn_nsdl, test_sn_nsdl_remove_resource_attribute)
{
    CHECK(test_sn_nsdl_remove_resource_attribute());
}
#endif
