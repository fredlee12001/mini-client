...
void set_default_attributes(sn_nsdl_static_resource_parameters_s *resource_parameters)
{
    if (resource_parameters) {
#ifndef RESOURCE_ATTRIBUTES_LIST
#ifndef DISABLE_RESOURCE_TYPE
        resource_parameters->resource_type_ptr = (uint8_t*)malloc(2);
        resource_parameters->resource_type_ptr[0] = 'a';
        resource_parameters->resource_type_ptr[1] = '\0';
#endif
#ifndef DISABLE_INTERFACE_DESCRIPTION
        resource_parameters->interface_description_ptr = (uint8_t*)malloc(2);
        resource_parameters->interface_description_ptr[0] = 'a';
        resource_parameters->interface_description_ptr[1] = '\0';
#endif
#else
        resource_parameters->attributes_ptr = malloc(sizeof(sn_nsdl_attribute_item_s) * 5);
        resource_parameters->attributes_ptr[0].attribute_name = ATTR_RESOURCE_TYPE;
        resource_parameters->attributes_ptr[0].value = malloc(2);
        resource_parameters->attributes_ptr[0].value[0] = 'a';
        resource_parameters->attributes_ptr[0].value[1] = '\0';
        resource_parameters->attributes_ptr[1].attribute_name = ATTR_INTERFACE_DESCRIPTION;
        resource_parameters->attributes_ptr[1].value = malloc(2);
        resource_parameters->attributes_ptr[1].value[0] = 'a';
        resource_parameters->attributes_ptr[1].value[1] = '\0';
        resource_parameters->attributes_ptr[2].attribute_name = ATTR_NOP;
        resource_parameters->attributes_ptr[2].value = 0;
        resource_parameters->attributes_ptr[3].attribute_name = ATTR_ENDPOINT_NAME;
        resource_parameters->attributes_ptr[3].value = malloc(2);
        resource_parameters->attributes_ptr[3].value[0] = 'c';
        resource_parameters->attributes_ptr[3].value[1] = '\0';
        resource_parameters->attributes_ptr[4].attribute_name = ATTR_END;
        resource_parameters->attributes_ptr[4].value = 0;
#endif
    }
}
#ifdef RESOURCE_ATTRIBUTES_LIST
void free_default_attributes(sn_nsdl_static_resource_parameters_s *resource_parameters)
{
    free(resource_parameters->attributes_ptr[0].value);
    free(resource_parameters->attributes_ptr[1].value);
    free(resource_parameters->attributes_ptr[3].value);
    free(resource_parameters->attributes_ptr);
}
#endif
...
bool test_sn_nsdl_register_endpoint()
{
    ...
    set_default_attributes(sn_grs_stub.expectedInfo->static_resource_parameters);
    sn_grs_stub.expectedInfo->observable = 1;


    sn_grs_stub.expectedInfo->path = malloc(2);
...
#ifndef RESOURCE_ATTRIBUTES_LIST
#ifndef DISABLE_INTERFACE_DESCRIPTION
    free(sn_grs_stub.expectedInfo->interface_description_ptr);
#endif
#ifndef DISABLE_RESOURCE_TYPE
    free(sn_grs_stub.expectedInfo->resource_type_ptr);
#endif
#else
    free_default_attributes(sn_grs_stub.expectedInfo->static_resource_parameters);
#endif
    ...
    sn_grs_stub.expectedInfo = (sn_nsdl_dynamic_resource_parameters_s*)malloc(sizeof(sn_nsdl_dynamic_resource_parameters_s));
    memset( sn_grs_stub.expectedInfo, 0, sizeof(sn_nsdl_dynamic_resource_parameters_s));
    sn_grs_stub.expectedInfo->static_resource_parameters->free_on_delete = true;
#ifndef RESOURCE_ATTRIBUTES_LIST
#ifndef DISABLE_RESOURCE_TYPE
    sn_grs_stub.expectedInfo->resource_type_ptr = (uint8_t*)malloc(UINT16_MAX);
    for(int i = 0; i < UINT16_MAX-1; i++) {
        sn_grs_stub.expectedInfo->resource_type_ptr[i] = 'a';
    }
    sn_grs_stub.expectedInfo->resource_type_ptr[UINT16_MAX-1] = '\0';
#endif
#ifndef DISABLE_INTERFACE_DESCRIPTION
    sn_grs_stub.expectedInfo->interface_description_ptr = (uint8_t*)malloc(2);
    sn_grs_stub.expectedInfo->interface_description_ptr[0] = 'a';
    sn_grs_stub.expectedInfo->interface_description_ptr[1] = '\0';
#endif
#else
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr = (sn_nsdl_attribute_item_s*)malloc(sizeof(sn_nsdl_attribute_item_s) * 3);
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].attribute_name = ATTR_RESOURCE_TYPE;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value = malloc(UINT16_MAX);
    for(int i = 0; i < UINT16_MAX-1; i++) {
        sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value[i] = 'a';
    }
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value[UINT16_MAX-1] = '\0';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].attribute_name = ATTR_INTERFACE_DESCRIPTION;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value = malloc(2);
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value[0] = 'a';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value[0] = '\0';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[2].attribute_name = ATTR_END;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[2].value = 0;
#endif
    sn_grs_stub.expectedInfo->observable = 1;
...
#endif
#else
    sn_nsdl_free_resource_attributes_list(sn_grs_stub.expectedInfo->static_resource_parameters);
#endif
    free(sn_grs_stub.expectedInfo);
...
#ifndef RESOURCE_ATTRIBUTES_LIST
#ifndef DISABLE_RESOURCE_TYPE
    sn_grs_stub.expectedInfo->resource_type_ptr = (uint8_t*)malloc(2);
    sn_grs_stub.expectedInfo->resource_type_ptr[0] = 'a';
    sn_grs_stub.expectedInfo->resource_type_ptr[1] = '\0';
#endif
#ifndef DISABLE_INTERFACE_DESCRIPTION
    sn_grs_stub.expectedInfo->interface_description_ptr = (uint8_t*)malloc(UINT16_MAX);
    for(int i = 0; i < UINT16_MAX-1; i++) {
        sn_grs_stub.expectedInfo->interface_description_ptr[i] = 'a';
    }
    sn_grs_stub.expectedInfo->interface_description_ptr[UINT16_MAX-1] = '\0';
#endif
#else
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr = (sn_nsdl_attribute_item_s*)malloc(sizeof(sn_nsdl_attribute_item_s) * 3);
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].attribute_name = ATTR_RESOURCE_TYPE;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value = malloc(2);
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value[0] = 'a';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[0].value[0] = '\0';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].attribute_name = ATTR_INTERFACE_DESCRIPTION;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value = malloc(UINT16_MAX);
    for(int i = 0; i < UINT16_MAX-1; i++) {
        sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value[i] = 'a';
    }
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[1].value[UINT16_MAX-1] = '\0';
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[2].attribute_name = ATTR_END;
    sn_grs_stub.expectedInfo->static_resource_parameters->attributes_ptr[2].value = 0;
#endif
    sn_grs_stub.expectedInfo->observable = 1;
    ...
    sn_grs_stub.expectedInfo->path = (uint8_t*)malloc(UINT16_MAX);
    memset(sn_grs_stub.expectedInfo->path, 'a', UINT16_MAX );
    sn_grs_stub.expectedInfo->path[UINT16_MAX-1] = '\0';
    sn_grs_stub.expectedInfo->publish_uri = 1;
    eptr->binding_and_mode = 0x06;
    retCounter = 7;
    ...
    sn_grs_stub.expectedInfo->path = (uint8_t*)malloc(UINT16_MAX-26);
    memset(sn_grs_stub.expectedInfo->path,'a', UINT16_MAX-26);
    sn_grs_stub.expectedInfo->path[UINT16_MAX-26-1] = '\0' ;
    sn_grs_stub.expectedInfo->publish_uri = 1;
    eptr->binding_and_mode = 0x06;
    retCounter = 7;
    ...
    sn_grs_stub.expectedInfo->path = malloc(UINT16_MAX-27);
    memset(sn_grs_stub.expectedInfo->path, 'a', UINT16_MAX-27);
    sn_grs_stub.expectedInfo->path[UINT16_MAX-27-1] = '\0' ;
    sn_grs_stub.expectedInfo->publish_uri = 1;
    eptr->binding_and_mode = 0x06;
    retCounter = 7;
    ...
    sn_grs_stub.expectedInfo->path = (uint8_t*)malloc(UINT16_MAX-28);
    memset(sn_grs_stub.expectedInfo->path, 'a', UINT16_MAX-28);
    sn_grs_stub.expectedInfo->path[UINT16_MAX-28-1] = '\0';
    sn_grs_stub.expectedInfo->publish_uri = 1;
    eptr->binding_and_mode = 0x06;
    retCounter = 7;
...
#ifdef RESOURCE_ATTRIBUTES_LIST
bool test_sn_nsdl_free_resource_attributes_list()
{
    uint8_t success = 0;
    sn_nsdl_static_resource_parameters_s sparams;
    sparams.free_on_delete = false;
    set_default_attributes(&sparams);

    sn_nsdl_free_resource_attributes_list(NULL);

    sn_nsdl_free_resource_attributes_list(&sparams);
    if (sparams.attributes_ptr == NULL) {
        return false;
    }

    sparams.free_on_delete = true;
    sn_nsdl_free_resource_attributes_list(&sparams);
    if (sparams.attributes_ptr != NULL) {
        return false;
    }
...
bool test_sn_nsdl_set_resource_attribute()
{
    sn_nsdl_static_resource_parameters_s sparams;
    sparams.free_on_delete = true;
    sparams.attributes_ptr = NULL;

    sn_nsdl_attribute_item_s attribute;
    attribute.attribute_name = ATTR_RESOURCE_TYPE;
    attribute.value = (char*)malloc(2);
    attribute.value[0] = 'a';
    attribute.value[1] = '\0';

    // NULL params
    if (sn_nsdl_set_resource_attribute(NULL, &attribute) != false) {
        return false;
    }

    // free_on_delete false should not add anything
    sparams.free_on_delete = false;
    if (sn_nsdl_set_resource_attribute(&sparams, &attribute) != false) {
        return false;
    }
    if (sparams.attributes_ptr != NULL) {
        return false;
    ...
    sparams.free_on_delete = true;
    // Add attribute to empty list
    if (sn_nsdl_set_resource_attribute(&sparams, &attribute) == false) {
        return false;
    }
    if (sparams.attributes_ptr == NULL
            || sparams.attributes_ptr[0].attribute_name != ATTR_RESOURCE_TYPE
            || sparams.attributes_ptr[0].value != attribute.value
            || sparams.attributes_ptr[1].attribute_name != ATTR_END) {
        return false;
    }

    // Modify existing attribute
    sn_nsdl_attribute_item_s attribute2;
    attribute2.attribute_name = ATTR_RESOURCE_TYPE;
    attribute2.value = (char*)malloc(2);
    attribute2.value[0] = 'b';
    attribute2.value[1] = '\0';

    if (sn_nsdl_set_resource_attribute(&sparams, &attribute2) == false) {
        return false;
    }
    if (sparams.attributes_ptr == NULL
            || sparams.attributes_ptr[0].attribute_name != ATTR_RESOURCE_TYPE
            || sparams.attributes_ptr[0].value != attribute2.value
            || sparams.attributes_ptr[1].attribute_name != ATTR_END) {
        return false;
    }

    // Add attribute to non-empty list
    sn_nsdl_attribute_item_s attribute3;
    attribute3.attribute_name = ATTR_INTERFACE_DESCRIPTION;
    attribute3.value = (char*)malloc(2);
    attribute3.value[0] = 'b';
    attribute3.value[1] = '\0';

    if (sn_nsdl_set_resource_attribute(&sparams, &attribute3) == false) {
        return false;
    }
    if (sparams.attributes_ptr == NULL
            || sparams.attributes_ptr[0].attribute_name != ATTR_RESOURCE_TYPE
            || sparams.attributes_ptr[0].value != attribute2.value
            || sparams.attributes_ptr[1].attribute_name != ATTR_INTERFACE_DESCRIPTION
            || sparams.attributes_ptr[1].value != attribute3.value
            || sparams.attributes_ptr[2].attribute_name != ATTR_END) {
        return false;
    }

    free(sparams.attributes_ptr[0].value);
    free(sparams.attributes_ptr[1].value);
    free(sparams.attributes_ptr);

    // Add attribute to list with NOP should replace NOP
    sparams.attributes_ptr = malloc(4 * sizeof(sn_nsdl_attribute_item_s));
    sparams.attributes_ptr[0].attribute_name = ATTR_RESOURCE_TYPE;
    sparams.attributes_ptr[0].value = (char*)malloc(2);
    sparams.attributes_ptr[0].value[0] = 'a';
    sparams.attributes_ptr[0].value[1] = '\0';
    sparams.attributes_ptr[1].attribute_name = ATTR_NOP;
    sparams.attributes_ptr[1].value = 0;
    sparams.attributes_ptr[2].attribute_name = ATTR_ENDPOINT_NAME;
    sparams.attributes_ptr[2].value = (char*)malloc(2);
    sparams.attributes_ptr[2].value[0] = 'b';
    sparams.attributes_ptr[2].value[1] = '\0';
    sparams.attributes_ptr[3].attribute_name = ATTR_END;
    sparams.attributes_ptr[3].value = 0;

    sn_nsdl_attribute_item_s attribute4;
    attribute3.attribute_name = ATTR_INTERFACE_DESCRIPTION;
    attribute3.value = (char*)malloc(2);
    attribute3.value[0] = 'c';
    attribute3.value[1] = '\0';

    if (sn_nsdl_set_resource_attribute(&sparams, &attribute3) == false) {
        return false;
    }
    if (sparams.attributes_ptr[1].attribute_name != ATTR_INTERFACE_DESCRIPTION ||
            sparams.attributes_ptr[1].value != attribute3.value) {
        return false;
    }
    ...
    free(sparams.attributes_ptr[0].value);
    free(sparams.attributes_ptr[1].value);
    free(sparams.attributes_ptr[2].value);
    free(sparams.attributes_ptr);

    return true;
}

bool test_sn_nsdl_get_resource_attribute()
{
    bool result = true;
    sn_nsdl_static_resource_parameters_s sparams;
    sparams.free_on_delete = true;
    ...
    if (sn_nsdl_get_resource_attribute(NULL, ATTR_ENDPOINT_NAME) != NULL) {
        result = false;
        goto finish;
    }

    if (sn_nsdl_get_resource_attribute(&sparams, ATTR_ENDPOINT_NAME) != NULL) {
        result = false;
        goto finish;
    }

    sparams.attributes_ptr = malloc(3 * sizeof(sn_nsdl_attribute_item_s));
    sparams.attributes_ptr[0].attribute_name = ATTR_RESOURCE_TYPE;
    sparams.attributes_ptr[0].value = (char*)malloc(2);
    sparams.attributes_ptr[0].value[0] = 'a';
    sparams.attributes_ptr[0].value[1] = '\0';
    sparams.attributes_ptr[1].attribute_name = ATTR_ENDPOINT_NAME;
    sparams.attributes_ptr[1].value = (char*)malloc(2);
    sparams.attributes_ptr[1].value[0] = 'b';
    sparams.attributes_ptr[1].value[1] = '\0';
    sparams.attributes_ptr[2].attribute_name = ATTR_END;
    sparams.attributes_ptr[2].value = 0;

    // Get existing attribute
    const char* attr_value = sn_nsdl_get_resource_attribute(&sparams, ATTR_ENDPOINT_NAME);
    if (attr_value == NULL) {
        result = false;
        goto cleanup;
    }
    if (result && strcmp(attr_value, "b") != 0) {
        result = false;
        goto cleanup;
    }

    // Get non-existing attribute
    attr_value = sn_nsdl_get_resource_attribute(&sparams, ATTR_INTERFACE_DESCRIPTION);
    if (attr_value != NULL) {
        result = false;
    }
...
bool test_sn_nsdl_remove_resource_attribute()
{
    bool result = true;
    sn_nsdl_static_resource_parameters_s sparams;
    sparams.free_on_delete = true;
    ...
    if (sn_nsdl_remove_resource_attribute(NULL, ATTR_ENDPOINT_NAME) != false) {
        result = false;
        goto finish;
    }

    if (sn_nsdl_remove_resource_attribute(&sparams, ATTR_ENDPOINT_NAME) != false) {
        result = false;
        goto finish;
    }
    ...
    // Test with free_on_delete = false, should do nothing
    sparams.free_on_delete = false;
    if (sn_nsdl_remove_resource_attribute(&sparams, ATTR_ENDPOINT_NAME) != false) {
        result = false;
        goto cleanup;
    ...
    sparams.free_on_delete = true;
    if (sn_nsdl_remove_resource_attribute(&sparams, ATTR_ENDPOINT_NAME) != true) {
        result = false;
        goto cleanup;
    }
    // Attribute should change to NOP
    if (sparams.attributes_ptr[1].attribute_name != ATTR_NOP ||
            sparams.attributes_ptr[1].value != NULL) {
        result = false;
        goto cleanup;
    }
