 ...
 */
// Note: content of sn_nsdl_static_resource_parameters_ is now back in sn_nsdl_resource_parameters_
...
typedef struct sn_nsdl_resource_parameters_ {
    ...
    unsigned        mode:2;                     /**< STATIC etc from sn_nsdl_resource_mode_e */
...
struct nsdl_s {
    ...
    sn_nsdl_dynamic_resource_parameters_s* (*sn_nsdl_get_first_callback)(struct nsdl_s *, struct iterator_state_s **, char **);
    sn_nsdl_dynamic_resource_parameters_s* (*sn_nsdl_get_next_callback)(struct nsdl_s *, struct iterator_state_s **, char **);
    sn_nsdl_dynamic_resource_parameters_s* (*sn_nsdl_find_resource_callback)(struct nsdl_s *, const char *);
...
#ifdef RESOURCE_ATTRIBUTES_LIST
/**
 * \fn int8_t sn_nsdl_free_resource_attributes_list(struct nsdl_s *handle, sn_nsdl_dynamic_resource_parameters_s *params)
 *
 * \brief Free resource attributes list. This will also free all attributes values if they are pointer types.
 *
 * \param *params Pointer to resource static parameters
 */
extern void sn_nsdl_free_resource_attributes_list(sn_nsdl_dynamic_resource_parameters_s *params);

/**
 * \fn bool sn_nsdl_set_resource_attribute(sn_nsdl_dynamic_resource_parameters_s *params, sn_nsdl_attribute_item_s attribute)
 *
 ...
 */
extern bool sn_nsdl_set_resource_attribute(sn_nsdl_dynamic_resource_parameters_s *params, const sn_nsdl_attribute_item_s *attribute);

/**
 * \fn bool sn_nsdl_get_resource_attribute(sn_nsdl_dynamic_resource_parameters_s *params, sn_nsdl_resource_attribute_t attribute)
 *
 ...
 */
extern const char* sn_nsdl_get_resource_attribute(const sn_nsdl_dynamic_resource_parameters_s *params, sn_nsdl_resource_attribute_t attribute);

/**
 * \fn bool sn_nsdl_remove_resource_attribute(sn_nsdl_dynamic_resource_parameters_s *params, sn_nsdl_resource_attribute_t attribute)
 *
 ...
 */
extern bool sn_nsdl_remove_resource_attribute(sn_nsdl_dynamic_resource_parameters_s *params, sn_nsdl_resource_attribute_t attribute);
#endif
