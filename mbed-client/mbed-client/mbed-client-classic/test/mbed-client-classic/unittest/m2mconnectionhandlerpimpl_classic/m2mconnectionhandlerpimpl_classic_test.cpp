...
TEST(M2MConnectionHandlerPimpl_classic, test_address_resolver)
{
    handler->test_address_resolver();
}

TEST(M2MConnectionHandlerPimpl_classic, test_handle_dns_result)
{
    handler->test_handle_dns_result();
}

TEST(M2MConnectionHandlerPimpl_classic, test_send_receive_event)
{
    handler->test_send_receive_event();
}

TEST(M2MConnectionHandlerPimpl_classic, test_close_socket)
{
