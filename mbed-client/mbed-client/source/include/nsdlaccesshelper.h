...
sn_nsdl_dynamic_resource_parameters_s *__get_first(struct nsdl_s * nsdl_handle, struct iterator_state_s** state, char **path);

sn_nsdl_dynamic_resource_parameters_s *__get_next(struct nsdl_s * nsdl_handle, struct iterator_state_s** state, char **path);
