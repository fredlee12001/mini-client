...
public:
     ...
     */
    static uint8_t* serialize(const M2MObjectInstance *object_instance_list, uint32_t &size);
     ...
     */
    static uint8_t* serialize_list(const M2MResource *resource_list, uint32_t &size);

    static uint8_t* serialize(const M2MResource *resource, uint32_t &size);

private :

    static uint8_t* serialize_object_instances(const M2MObjectInstance *object_instance_list, uint32_t &size);

    static uint8_t* serialize_resources(const M2MResource *resource_list, uint32_t &size, bool &valid);
