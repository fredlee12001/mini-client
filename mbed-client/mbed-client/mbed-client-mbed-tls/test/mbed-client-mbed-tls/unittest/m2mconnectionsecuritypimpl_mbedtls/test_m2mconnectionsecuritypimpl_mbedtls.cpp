...
void Test_M2MConnectionSecurityPimpl::test_destructor()
{
    ...
    impl = new M2MConnectionSecurityPimpl(M2MConnectionSecurity::TLS);
    impl->_init_done = M2MConnectionSecurityPimpl::INIT_CONFIGURING;
    delete impl;
...
void Test_M2MConnectionSecurityPimpl::test_connect()
{
    ...
    pal_tls_stub::status = PAL_ERR_TLS_WANT_READ;
    pal_tls_stub::change_status_count = 0;
    impl._init_done = M2MConnectionSecurityPimpl::INIT_DONE;
...

{
    ...
    pal_tls_stub::status = PAL_ERR_TLS_WANT_WRITE;
    pal_tls_stub::change_status_count = 0;
    impl._init_done = M2MConnectionSecurityPimpl::INIT_DONE;
...
void Test_M2MConnectionSecurityPimpl::test_check_security_object_validity()
{
    ...
    m2msecurity_stub::value_ptr = (uint8_t*)malloc(5);
    memset(m2msecurity_stub::value_ptr, 'a', 5);
    m2mdevice_stub::int_value = 0;
    CHECK(impl.check_security_object_validity(&security));

    m2mdevice_stub::int_value = 100;
    CHECK(!impl.check_security_object_validity(&security));
    ...
    free(m2msecurity_stub::value_ptr);
}
