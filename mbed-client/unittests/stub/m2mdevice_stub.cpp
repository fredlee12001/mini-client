...
M2MDevice *m2mdevice_stub::instance;
...
{
    if(!m2mdevice_stub::instance) {
        m2mdevice_stub::instance = new M2MDevice("3");
    }
    return m2mdevice_stub::instance;
}

void M2MDevice::delete_instance()
{
    delete m2mdevice_stub::instance;
}
