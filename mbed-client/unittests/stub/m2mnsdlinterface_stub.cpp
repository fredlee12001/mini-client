...
void M2MNsdlInterface::create_endpoint(const char *,
                                       const char *,
                                       const int32_t,
                                       const char *,
                                       const uint8_t,
...
bool M2MNsdlInterface::send_update_registration(const uint32_t, bool)
{
    return m2mnsdlinterface_stub::bool_value;
}
...
{
    return m2mnsdlinterface_stub::string_value->c_str();
}
...
void M2MNsdlInterface::update_endpoint(const char *)
{
...
void M2MNsdlInterface::update_domain(const char *)
{
