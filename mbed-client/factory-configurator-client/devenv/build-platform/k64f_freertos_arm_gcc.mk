...
# ----------------------------------------------------------------------------
# Makefile for FRDM-K64F mbed arm-none-eabi-gcc platform
# The target is a single bare-metal image (.elf --> .bin)

include $(SA_PV_TOP)/devenv/build-common/locations.mk

# Keep defines before `k64f_common.mk`
BUILD_TOOLCHAIN := GCC_ARM
BUILD_DIR       := $(FREERTOS_BUILD_DIR)
BUILD_OS_BRAND  := free-rtos
INSTALL_LICENSE :=
