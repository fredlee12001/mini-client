...
def build_tests(tests, base_source_paths, build_path, target, toolchain_name,
    ...
    # FIXME: local fix for bug of macros overwrite.
    # The bug cause that the macros that are delivered from the user aren't used for compilation of main in the TESTS
    cfg, macros_toolchain, features = get_config(base_source_paths, target_name, toolchain_name)
    macros += macros_toolchain
