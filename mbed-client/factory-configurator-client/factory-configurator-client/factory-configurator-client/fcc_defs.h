...
/**
* Firmware integrity ca certificate parameter name.
*/
extern const char g_fcc_firmware_integrity_ca_certificate_name[];
/**
* Firmware integrity certificate parameter name.
*/
extern const char g_fcc_firmware_integrity_certificate_name[];
