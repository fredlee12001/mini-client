...
const char g_fcc_invalid_certificate_error_str[] = "Invalid certificate:";
const char g_fcc_item_not_exists_error_str[] = "Item not exists:";
const char g_fcc_wrong_item_size_error_str[] = "Item size is wrong:";
const char g_fcc_empty_item_error_str[] = "Item is empty:";
const char g_fcc_uri_wrong_format_error_str[] = "Wrong uri format:";
const char g_fcc_wrong_utc_offset_value_error_str[] = "Wrong utc offset:";
const char g_fcc_wrong_bootstrap_use_value_error_str[] = "Wrong value of bootstrap mode:";
const char g_fcc_not_permitted_error_str[] = "This operation is not permitted:";
const char g_fcc_wrong_ca_certificate_error_str[] = "Failed in check of CA certificate:";
const char g_fcc_invalid_cn_certificate_error_str[] = "Ivalid certificate's CN attribute:";

//kcm crypto error strings
const char g_fcc_kcm_file_error_str[] = "File operation general error:";
const char g_fcc_kcm_invalid_file_version_str[] = "File version is invalid:";
const char g_fcc_kcm_file_data_corrupted_str[] = "File data corrupted error:";
const char g_fcc_kcm_file_name_corrupted_str[] = "File name corrupted error:";
const char g_fcc_kcm_not_initialized_str[] = "KCM not initialized:";
const char g_fcc_kcm_file_exist_error_str[] = "The data is already exists:";
const char g_fcc_crypto_empty_item_error_str[] = "The data of the item is empty:";
const char g_fcc_crypto_unsupported_hash_mode_error_str[] = "Unsupported hash mode:";
const char g_fcc_crypto_parsing_der_pivate_key_error_str[] = "Failed to parse der private key:";
const char g_fcc_crypto_parsing_der_public_key_error_str[] = "Failed to parse der public key:";
const char g_fcc_crypto_verify_private_key_error_str[] = "Failed to verify private key:";
const char g_fcc_crypto_verify_public_key_error_str[] = "Failed to verify public key:";
const char g_fcc_crypto_unsupported_curve_error_str[] = "Unsupported curve:";
const char g_fcc_crypto_parsing_der_cert_error_str[] = "Failed to parse der certificate:";
const char g_fcc_crypto_cert_expired_error_str[] = "Certificate validity is expired:";
const char g_fcc_crypto_cert_future_error_str[] = "Future Certificate validity:";
...
const char g_fcc_crypto_cert_not_trusted_error_str[] = "Certificate is not trusted:";
const char g_fcc_crypto_invalid_x509_attr_error_str[] = "Invalid x509 attribute:";
const char g_fcc_crypto_invalid_pk_key_format_error_str[] = "Ivalid pk key format:";
const char g_fcc_crypto_invalid_public_key_error_str[] = "Invalid public key:";
const char g_fcc_crypto_ecp_invalid_key_error_str[] = "Invalid ecp key:";
const char g_fcc_crypto_pk_key_invalid_version_error_str[] = "Pk version of key is invalid:";
const char g_fcc_crypto_pk_password_requerd_error_str[] = "Pk password requerd:";
const char g_fcc_crypto_unknown_pk_algorithm_error_str[] = "Unknown pk algorithm:";

//warning strings
const char g_fcc_bootstrap_mode_false_warning_str[] = "No bootstrap mode:";
const char g_fcc_time_is_not_set_warning_str[] = "The device time wasn't set:";
const char g_fcc_self_signed_warning_str[] = "The certificate is self signed:";
const char g_fcc_item_is_empty_warning_str[] = "The item is empty:";
const char g_fcc_redundant_item_warning_str[] = "The item should not be present:";
const char g_fcc_time_zone_is_not_set_warning_str[] = "The time zone wasn't set:";
const char g_fcc_utc_offset_is_not_set_warning_str[] = "The UTC offset wasn't set:";
const char g_fcc_cert_time_validity_warning_str[] = "The certificate validity can not be checked:";
const char g_fcc_cert_validity_less_10_years_warning_str[] = "The certificate validity is less than 10 years:";
const char g_fcc_missing_parameter_warning_str[] = "The parameter is missing:";
...
static void fcc_free_list_of_warnings(fcc_warning_info_s  *output_warning_info)
{
    ...
    while (current_node != NULL) {
        if (current_node->warning_info_string != NULL) {
            free(current_node->warning_info_string);
        }
        free(current_node);
...
static fcc_status_e fcc_set_output_string_info(const char *message_string, const uint8_t *failed_item_name, size_t failed_item_name_size, char **out_string)
{
    ...
    *out_string = malloc(strlen(message_string) + failed_item_name_size + 1); // 1 char for '\0'
...
void  fcc_clean_output_info_handler()
{
    ...
    free(g_output_info.error_string_info);
    g_output_info.error_string_info = NULL;
...
fcc_status_e fcc_store_warning_info(const uint8_t *failed_item_name, size_t failed_item_name_size, const char *warning_string)
{
    ...
    //Allocate new node
    new_node = (fcc_warning_info_s*)malloc(sizeof(fcc_warning_info_s));
...
char*  fcc_get_output_warning_info()
{
    ...
    if (g_output_info.head_of_warning_list == NULL || g_output_info.size_of_warning_info_list == 0) {
        ...
        warrning_string_collection = malloc(total_size_of_strings_with_delimeters);
        ...
        if (status != true) {
            free(warrning_string_collection);
            return NULL;
        }
    }
