...
extern const char g_fcc_time_zone_is_not_set_warning_str[];
extern const char g_fcc_utc_offset_is_not_set_warning_str[];
extern const char g_fcc_cert_time_validity_warning_str[];
extern const char g_fcc_cert_validity_less_10_years_warning_str[];
extern const char g_fcc_missing_parameter_warning_str[];
#ifdef __cplusplus
}
#endif
